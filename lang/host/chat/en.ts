export const en = new Map([
  ...
  [
    ...
    ': failed to handle accepting or rejecting for this client.',
  ],
  [
    'confirm-closing-request',
    'Requests for joining to this chat will be closed. No more new members?',
  ],
  [
    'closing-request-failed',
    'Failed to close accepting requests. Sorry for the inconvenience! Please wait for a while and retry',
  ],
  ['accept-button', 'Accept'],
  ['reject-button', 'Reject'],
  ['visitor-codename', 'Codename'],
  ['visitor-passphrase', 'Passphrase'],
