export const ja = new Map([
  ...
  ['send-button', '送信'],
  ['send-button-message', '[shift]+[enter] でもメッセージを送信できます'],
  ['chat-label', 'メッセージ'],
  ...
  [
    ...
    'への許可・拒否送信でエラーが正しく処理できませんでした',
  ],
  [
    'confirm-closing-request',
    'チャットへの新規参加者を終了してよろしいですか?',
  ],
  [
    'closing-request-failed',
    '新規参加者の終了の処理ができませんでした。お手数ですが、少し時間を置いて、再度実行して下さい',
  ],

  ['accept-button', '許可'],
  ['reject-button', '拒否'],
  ['visitor-codename', 'コードネーム'],
  ['visitor-passphrase', '合言葉'],
  ['visitor-status', 'ステータス'],
])
